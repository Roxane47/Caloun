...
?>
	...
	$comment_form_args = array(
			...
			'title_reply'       => __( 'Partagez votre avis', 'cc2' ),  // that's the wordpress default value! delete it or edit it ;)
			'title_reply_to'    => __( 'Répondre à %s', 'cc2' ),  // that's the wordpress default value! delete it or edit it ;)
			'cancel_reply_link' => __( 'Effacer', 'cc2' ),  // that's the wordpress default value! delete it or edit it ;)
			'label_submit'      => __( 'Envoyer', 'cc2' ),  // that's the wordpress default value! delete it or edit it ;)

			'comment_field' =>  sprintf( '<div class="form-group"><div class="col-md-12 col-lg-12"><p><textarea placeholder="%s" id="comment" class="form-control" name="comment" cols="45" rows="8" aria-required="true"></textarea></p></div></div>', __('Votre commentaire...', 'cc2') ), 
